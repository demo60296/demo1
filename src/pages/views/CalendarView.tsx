    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <div
          ...
          className={`h-16 sm:h-20 lg:h-24 border border-gray-200 p-1 sm:p-2 cursor-pointer hover:bg-gray-50 transition-colors ${
              ...
              <div className="flex-1 space-y-0.5 sm:space-y-1">
                {dayData.income > 0 && (
                  <div className="flex items-center text-xs">
                    <TrendingUp className="w-2 h-2 sm:w-3 sm:h-3 text-green-600 mr-1" />
                ...
                {dayData.expense > 0 && (
                  <div className="flex items-center text-xs">
                    <TrendingDown className="w-2 h-2 sm:w-3 sm:h-3 text-red-600 mr-1" />
